...
_MATH_OPS: Tuple[Tuple[str, str, str, Optional[str], str, Tuple[str, ...], str], ...] = (
    ...
    (
        ...
        None,
        "filter",
        ("butterworth", "lowpass", "highpass", "bandpass", "bandstop", "cutoff"),
        "Open Math Lab on a zero-phase Butterworth filter of the selected layer.",
    ),
    (
        "math.detrend",
        "detrend",
        ...
        None,
        "grid",
        ("detrend", "baseline", "asls", "flatten", "offset"),
        "Open Math Lab on removing a constant, linear or curved baseline.",
    ),
    (
        "math.autocorr",
        "autocorr",
        ...
        None,
        "loop",
        ("autocorrelation", "period", "repeat", "lag", "self-similarity"),
        "Open Math Lab on the autocorrelation of the selected layer.",
    ),
    (
        "math.peaks",
        "peaks",
        ...
        None,
        "target",
        ("peak detection", "prominence", "local maxima", "find peaks"),
        "Open Math Lab on detecting peaks in the selected layer.",
    ),
    (
        "math.histogram",
        "histogram",
        ...
        None,
        "chart_bar",
        ("distribution", "bins", "density", "frequency"),
        "Open Math Lab on the histogram of the selected layer.",
    ),
    (
        "math.dynamics",
        "dynamics",
        ...
        None,
        "orbit",
        ("phase portrait", "return map", "lyapunov", "chaos", "takens", "embedding"),
        "Open Math Lab on the dynamical-systems view (phase portrait, return map, "
        "Lyapunov exponent) of the selected layer.",
    ),
    (
        "math.correlate",
        "correlate",
        ...
        None,
        "chart_scatter",
        ("pearson", "spearman", "covariance", "regression", "relationship"),
        "Open Math Lab on the correlation between the selected layer's x and y columns.",
    ),
    (
        "math.cluster",
        "cluster",
        ...
        None,
        "chart_scatter3d",
        ("kmeans", "k-means", "clustering", "groups", "segmentation"),
        "Open Math Lab on k-means clustering of the selected layer's (x, y) points.",
    ),
    (
        "math.density2d",
        "density2d",
        ...
        None,
        "chart_bar3d",
        ("heatmap", "heat map", "kde", "kernel density", "histogram2d", "hist2d"),
        "Open Math Lab on the 2-D density (histogram or KDE) of the selected layer's "
        "(x, y) points.",
    ),
    (
        "math.envelope",
        ...
        None,
        "wave",
        ("hilbert", "amplitude", "modulation", "am", "analytic signal"),
        "Open Math Lab on the amplitude envelope of the selected layer.",
    ),
    (
        "math.rolling",
        "rolling",
        ...
        None,
        "timeline",
        ("moving average", "rolling mean", "rolling std", "window", "volatility"),
        "Open Math Lab on a moving-window statistic of the selected layer.",
    ),
    (
        "math.spatial",
        "spatial",
        ...
        None,
        "target",
        ("convex hull", "nearest neighbor", "spacing", "bounding box", "spatial stats"),
        "Open Math Lab on the spatial statistics (spacing, hull) of the selected "
        "layer's (x, y) points.",
    ),
    (
        "math.compare",
        ...
        None,
        "table",
        ("t-test", "hypothesis test", "mann-whitney", "kolmogorov-smirnov", "two-sample"),
        "Open Math Lab on a two-sample hypothesis test between the selected layer's y "
        "and another column.",
    ),
    (
        "math.pca",
        ...
        None,
        "axes3d",
        ("principal component analysis", "dimensionality reduction", "svd", "projection"),
        "Open Math Lab on a principal component analysis of several dataset columns.",
    ),
    (
        "math.umap",
        "umap",
        ...
        None,
        "layers",
        ("dimensionality reduction", "manifold", "embedding", "nonlinear projection"),
        "Open Math Lab on a UMAP embedding of several dataset columns.",
    ),
)
