...
def main():
    ...
    try:
        ...
        axes[curr_ax].set_title("GLPlot GPU Analytical Density (Heatmap)", fontsize=13, fontweight="bold", pad=10)
        curr_ax += 1
        ...
        if vp_out:
            ...
            axes[curr_ax].axis("off")
            axes[curr_ax].set_title("VisPy GPU Segment Blending (OpenGL)", fontsize=13, fontweight="bold", pad=10)
            curr_ax += 1
        ...
        if fpl_out:
            ...
            axes[curr_ax].axis("off")
            axes[curr_ax].set_title("fastplotlib GPU Segment Blending (WGPU)", fontsize=13, fontweight="bold", pad=10)
            curr_ax += 1
