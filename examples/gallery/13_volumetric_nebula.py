...
plt.volume3d(x, y, z, energy, threshold=0.14, cmap="magma", alpha=0.42, s=1.2, elev=24, azim=-52, label="volumetric samples")
plt.scatter3d(x[::450], y[::450], z[::450], c=energy[::450], cmap="turbo", s=2, elev=24, azim=-52, label="bright probes")
